...
pub const App = struct {
    ...
    graphics: VulkanQueue,
    compute: VulkanQueue,
    present: VulkanQueue,
    transfer: VulkanQueue,
    // App state
    debug: bool,
    ...
    const Self = App;
    const VulkanQueue = vk_common.VulkanQueue;
    const notVkSuccess = vk_common.notVkSuccess;
    const debugCallback = vk_common.debugCallback;
    const containsBitFlag = vk_common.containsBitFlag;

    pub fn init(opt: AppOptions, allocator: std.mem.Allocator) !Self {
    ...
    fn initGlfw(self: *Self, opt: AppOptions) !void {
    ...
    fn pickQueues(self: *Self) !void {
        ...
        var graphics: ?VulkanQueue = null;
        var compute: ?VulkanQueue = null;
        var present: ?VulkanQueue = null;
        var transfer: ?VulkanQueue = null;
